...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className='home__subtitle'>React Devoloper</h3>
            <p className='home__description'> I`m creative FrontEnd devoloper based in Khorezm , and I`m very passionate a d dedicated to my work.</p>

            <a href="#contact" className='button btnSayHello button--flex'>
                Say Hello
                <svg
